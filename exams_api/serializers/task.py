...
class TaskBaseSerializer(serializers.ModelSerializer):
    ...
    default_error_messages = {
        "cant_start_task": "You did not create an Exam which contains this Task Sheet."
                           " You can't answer this Task Sheet now.",
    }
    ...
    class Meta:
        model = Task
        fields = ('id', 'user', 'task_sheet', 'answer', 'right_answer', 'score',)
        read_only_fields = ('id', 'created', 'user', 'score',)
